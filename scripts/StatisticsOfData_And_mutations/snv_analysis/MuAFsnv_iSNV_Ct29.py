...
import MuAFsnv_iSNV_Ct29_module  as shared_snvMOD
#1
...
def main():
	...
	for flag in flagLst:	
		singleXins = shared_snvMOD.outAllSampFStat(allSampsAnno,sampleCtdic,flag)
		...
		effDic = singleXins[3]
		lieDic = shared_snvMOD.iSNVlieDic(iSNV)
